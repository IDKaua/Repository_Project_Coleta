...
// ── Helpers ──────────────────────────────────────────────────────────────────
// Converte lat/lng para posição % no mapa (projeção equiretangular simples)
...
const IconRecycle = () => (
  <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" width="20" height="20">
    <path d="M7 19H4.815a1.83 1.83 0 0 1-1.57-.881 1.785 1.785 0 0 1-.004-1.784L7.196 9.5"/><path d="M11 19h8.203a1.830 1.830 0 0 0 1.556-.89 1.784 1.784 0 0 0 0-1.775l-1.226-2.12"/><path d="m14 16 3 3-3 3"/><path d="M8.293 13.596 7.196 9.5 3.1 10.598"/><path d="m9.344 5.811 1.093-1.892A1.83 1.83 0 0 1 11.985 3a1.784 1.784 0 0 1 1.546.888l3.943 6.843"/><path d="m13.378 9.633 4.096 1.098 1.097-4.096"/>
  </svg>
);
      ...
      <div className="mapa-layout">
        ...
        <aside className="mapa-sidebar">
          <section className="sidebar-section">
            ...
            <ul className="sidebar-menu">
              ...
              >
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" width="16" height="16"><circle cx="12" cy="10" r="3"/><path d="M12 2a8 8 0 0 0-8 8c0 5.25 8 14 8 14s8-8.75 8-14a8 8 0 0 0-8-8z"/></svg>
                Mapas
              </li>
            </ul>
          </section>
        ...
        <main className="mapa-main">
          ...
          <div className="mapa-page-header">
            <h1 className="mapa-titulo">MAPA OPERACIONAL <span>– [Nome da Cooperativa Exemplo]</span></h1>
          ...
          <div className="mapa-content-row">
            ...
            <div className="mapa-card mapa-map-card">
              <div className="mapa-map-area">
                {/* SVG do mapa-mundi simplificado (outline) */}
                <svg
                  className="world-svg"
            ...
            <div className="mapa-card mapa-details-card">
              ...
              {selected ? (
                <>
                  <span className="details-badge">{selected.tipo === "coleta" ? "Coleta" : "Contêiner"}</span>
                ...
                <div className="details-empty">
                  <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" width="40" height="40"><circle cx="12" cy="10" r="3"/><path d="M12 2a8 8 0 0 0-8 8c0 5.25 8 14 8 14s8-8.75 8-14a8 8 0 0 0-8-8z"/></svg>
